  ...
  const mxArray * prhs[] )
{
  ...
  extern unsigned int sf_spsSupercapacitor_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_model_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_spsSupercapacitor_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_model_autoinheritance_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_spsSupercapacitor_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "spsSupercapacitor") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_spsSupercapacitor_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_model_third_party_uses_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_spsSupercapacitor_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "spsSupercapacitor") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_spsSupercapacitor_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_model_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_spsSupercapacitor_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "spsSupercapacitor") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_spsSupercapacitor_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_spsSupercapacitor_method_dispatcher(SimStruct *S,
  ...
  method, void *data)
{
  ...
  if (!strcmp(machineName,"spsSupercapacitor")) {
    return(sf_spsSupercapacitor_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void spsSupercapacitor_initializer(void);
extern void model_register_exported_symbols(SimStruct* S);
extern void spsSupercapacitor_register_exported_symbols(SimStruct* S);
extern void model_debug_initialize(struct SfDebugInstanceStruct*);
extern void spsSupercapacitor_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  model_register_exported_symbols(S);
  spsSupercapacitor_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    model_initializer();
    if (!simModeIsRTWGen) {
      spsSupercapacitor_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    spsSupercapacitor_initializer();
  }
